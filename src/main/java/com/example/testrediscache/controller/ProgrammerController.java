...
public class ProgrammerController {
    ...
    @GetMapping
    public List<Programmer> findProgrammerByMainLanguage(@RequestParam(required = false) String mainLanguage) {
    ...
    public ResponseEntity<Object> saveProgrammer(@RequestBody Programmer programmer) {
        ...
        return Optional.ofNullable(programmer)
                ...
                .orElse(ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Error saving programmer" + programmer));
    }
}
